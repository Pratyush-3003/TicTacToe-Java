...
public class CommonConstants {
    ...
    //size config
    public static final Dimension FRAME_SIZE = new Dimension(540, 720);
    ...
    public static final Dimension RESULT_DIALOG_SIZE =  new Dimension((int)(FRAME_SIZE.width/3), (int)(FRAME_SIZE.height/3));
    //value config
    public static final String X_LABEL = "X";
    public static final String O_LABEL = "O";
    public static final String SCORE_LABEL = "X:0 | Y:0";
